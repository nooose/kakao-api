...
import com.example.apiproject.pharmacy.service.PharmacyRecommendationService
...
class FormControllerTest extends Specification {
    ...
    def "POST /search"() {
        ...
        then:
        1 * pharmacyRecommendationService.recommendPharmacies(argument -> {
        ...
        resultActions
                ...
                .andExpect(model().attribute("outputFormList", outputDtos))
                .andDo(print())
    }
}
